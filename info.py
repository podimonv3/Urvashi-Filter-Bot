...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002277855109 -1002588309941').split()]
if len(INDEX_CHANNELS) == 0:
    logger.info('INDEX_CHANNELS is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002517207858')
if len(LOG_CHANNEL) == 0:
    logger.error('LOG_CHANNEL is missing, exiting now')
    exit()
else:
    LOG_CHANNEL = int(LOG_CHANNEL)
UPDATES_SEND_CHANNEL = environ.get('UPDATES_SEND_CHANNEL', '-1003917996684')
...
REQUESTS_CHANNEL = environ.get('REQUESTS_CHANNEL', '-1004427487424')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002563100745')
...
VERIFY_TUTORIAL = environ.get("VERIFY_TUTORIAL", "https://t.me/+V_bVb-RsTQxkZjM1")
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1004427487424")
